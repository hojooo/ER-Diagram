CREATE TABLE "visual_command_receipts" (
  ...
  CONSTRAINT "visual_command_receipts_command_kind" CHECK (
    "command_kind" IN (
      ...
      'CREATE_COLUMN', 'UPDATE_COLUMN', 'RENAME_COLUMN', 'REORDER_COLUMN', 'DELETE_COLUMN',
...
UPDATE "app_metadata" SET "value" = '2' WHERE "key" = 'storage_schema_version';
